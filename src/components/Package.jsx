...
export default function Package(){
     ...
     function navi(){
          if(window.location.pathname ==='/takeAway'){
             ...
             //
             overAllData['packageType'] = document.getElementById('spec1').checked ?? document.getElementById('spec').checked
             //
             console.log(overAllData);
               ...
               //
               overAllData['specification'] = document.getElementById('spec1').checked ?? document.getElementById('spec').checked
               //
               console.log(overAllData);
          }
     }
     ...
     function notFound(){
            return(
              ...
              .container{
                ...
                <div className="heading">
                   <h1 style={{color:'red'}}>PageNotFount err:404</h1>
               </div>
               <div id="notFoundBody">
